         ...
         <div class="isi-about">
            ...
            <div class="skill">
               ...
               <div class="skills" v-for="item in skill">
                  <h2>HTML and CSS</h2>
                  <p class="isi-skill">Bootstrap (3+), Sass</p>
                  <h2>JavaScript</h2>
                  <p class="isi-skill">Node Js(AKAN DILEPAJARI) </p>
         
                  <h2>JavaScript frameworks</h2>
                  <p class="isi-skill">jQuery, Vue.js</p>
                  <h2>Server-side</h2>
                  <p class="isi-skill">PHP</p>
                  <h2>Server-side frameworks</h2>
                  <p class="isi-skill"> Laravel(AKAN DIPELAJARI)</p>
                  <h2>Others</h2>
                  <p class="isi-skill">Git, SQL</p>
               </div>
               <br>
               <hr><br>
